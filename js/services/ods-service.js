...
import odsService from './ods-service.js';

// Exporta o serviço para uso em outros módulos
export default odsService;

// Para compatibilidade com scripts que usam acesso global
window.odsService = odsService;

/**
 * ods-service.js
 * Serviço responsável pela busca e gerenciamento dos dados ODS
 */
